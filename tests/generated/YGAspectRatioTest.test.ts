...
Deno.test(
  "aspect_ratio_does_not_stretch_cross_axis_dim",
  { ignore: true },
  () => {
    ...
    try {
      ...
      root_child0_child0_child2.insertChild(
      ...
      root_child0_child0_child2_child0.insertChild(
      ...
      expect(root_child0_child0_child2_child0_child0.getComputedWidth()).toBe(
        5,
      );
      expect(root_child0_child0_child2_child0_child0.getComputedHeight()).toBe(
        0,
      );
      ...
      expect(root_child0_child0_child2_child0_child1.getComputedWidth()).toBe(
        98,
      );
      expect(root_child0_child0_child2_child0_child1.getComputedHeight()).toBe(
        197,
      );
      ...
      expect(root_child0_child0_child2_child0_child0.getComputedLeft()).toBe(
        93,
      );
      expect(root_child0_child0_child2_child0_child0.getComputedTop()).toBe(0);
      expect(root_child0_child0_child2_child0_child0.getComputedWidth()).toBe(
