...
Deno.test("column_gap_inflexible", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_mixed_flexible", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_child_margins", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_row_gap_wrapping", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_start_index", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_flex_start", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_center", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_flex_end", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_space_between", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_space_around", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_justify_space_evenly", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_flex_start", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_center", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_flex_end", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_space_between", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_space_around", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_wrap_align_stretch", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_gap_determines_parent_width", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_align_items_stretch", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_align_items_end", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_column_child_margins", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_row_wrap_child_margins", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_determines_parent_height", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_determines_parent_height", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_both_content_padding_and_item_padding", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_both_content_padding", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_content_margin", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_content_margin_and_padding", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_flexible_content", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_mixed_flexible_content", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("row_gap_percent_wrapping_with_min_width", { ignore: true }, () => {
  const config = Yoga.Config.create();
  let root;
