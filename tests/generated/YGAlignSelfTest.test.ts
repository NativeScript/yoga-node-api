...
Deno.test("align_self_flex_start", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("align_self_flex_end_override_flex_start", () => {
  const config = Yoga.Config.create();
  let root;
