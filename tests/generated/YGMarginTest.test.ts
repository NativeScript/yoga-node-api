...
Deno.test("margin_and_flex_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_and_stretch_row", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_and_stretch_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_with_sibling_row", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_with_sibling_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_bottom_and_top", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_bottom_and_top_justify_center", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_multiple_children_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_multiple_children_row", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_and_right_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_and_right", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_start_and_end_column", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_start_and_end", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_and_right_column_and_center", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_and_right_stretch", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_top_and_bottom_stretch", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_should_not_be_part_of_max_height", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_should_not_be_part_of_max_width", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_right_child_bigger_than_parent", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_child_bigger_than_parent", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_fix_left_auto_right_child_bigger_than_parent", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_fix_right_child_bigger_than_parent", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_top_stretching_child", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_left_stretching_child", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("margin_auto_overflowing_container", () => {
  const config = Yoga.Config.create();
  let root;
