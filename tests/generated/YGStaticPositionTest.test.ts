...
Deno.test("static_position_insets_have_no_effect_left_top", () => {
...
Deno.test("static_position_insets_have_no_effect_right_bottom", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_insets_relative_to_positioned_ancestor", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_insets_relative_to_positioned_ancestor_row_reverse", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_reverse_static_position_absolute_child_insets_relative_to_positioned_ancestor_row_reverse", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_insets_relative_to_positioned_ancestor_row", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_reverse_static_position_absolute_child_insets_relative_to_positioned_ancestor_row", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_insets_relative_to_positioned_ancestor_column_reverse", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("column_reverse_static_position_absolute_child_insets_relative_to_positioned_ancestor_column_reverse", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_insets_relative_to_positioned_ancestor_deep", () => {
  const config = Yoga.Config.create();
  let root;
  ...
  try {
    ...
    root_child0_child0_child0_child0_child0.setPositionType(
      PositionType.Static,
    );
    ...
    root_child0_child0_child0_child0.insertChild(
      root_child0_child0_child0_child0_child0,
      0,
    );

    const root_child0_child0_child0_child0_child0_child0 = Yoga.Node.create(
      config,
    );
    root_child0_child0_child0_child0_child0_child0.setPositionType(
    ...
    root_child0_child0_child0_child0_child0.insertChild(
    ...
    expect(root_child0_child0_child0_child0_child0.getComputedWidth()).toBe(
      100,
    );
    expect(root_child0_child0_child0_child0_child0.getComputedHeight()).toBe(
      100,
    );

    expect(root_child0_child0_child0_child0_child0_child0.getComputedLeft())
      .toBe(-350);
    expect(root_child0_child0_child0_child0_child0_child0.getComputedTop())
      .toBe(50);
    expect(root_child0_child0_child0_child0_child0_child0.getComputedWidth())
      .toBe(50);
    expect(root_child0_child0_child0_child0_child0_child0.getComputedHeight())
      .toBe(50);
...
Deno.test("static_position_absolute_child_width_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_width_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_width_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_height_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_height_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_height_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_left_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_left_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_left_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_right_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_right_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_right_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_top_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_top_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_top_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_bottom_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_bottom_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_bottom_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_margin_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_margin_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_margin_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_padding_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_padding_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_padding_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_border_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_border_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_border_percentage", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_containing_block_padding_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_containing_block_padding_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_containing_block_padding_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_absolute_child_containing_block_content_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_relative_child_containing_block_content_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_child_containing_block_content_box", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_containing_block_padding_and_border", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_no_position_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_zero_for_inset_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_start_inset_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_end_inset_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_row_reverse_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_column_reverse_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_justify_flex_start_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_justify_flex_start_position_set_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_no_definite_size_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_both_insets_set_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_justify_center_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_justify_flex_end_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_align_flex_start_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_align_center_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_align_flex_end_amalgamation", () => {
  const config = Yoga.Config.create();
  let root;
...
Deno.test("static_position_static_root", () => {
  const config = Yoga.Config.create();
  let root;
